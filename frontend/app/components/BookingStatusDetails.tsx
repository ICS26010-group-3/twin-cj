...
const BookingStatusDetails = (props: any) => {
    if(props.status === "Approved") {
                ...
                <div className={`${styles["booking-status-details-container"]}`}>
                    ...
                    <div className={`${styles["booking-status-details-container-sub"]}`}>
                        <div className={`${styles["booking-status-details-left"]}`}>
                            <p><b>Status:&nbsp;</b><span style={{ color: "green", fontStyle: "italic" }}>Approved Downpayment</span></p>
            ...
            <section className={`${styles["booking-status-details-section"]}`}>
                <div className={`${styles["booking-status-details-container"]}`}>
                    <div className={`${styles["booking-status-details-container-heading"]}`}>
                        ...
                        <h4>Thank you for your booking! Your reservation is currently being processed. Please check back later for updates or take the steps below if needed.</h4>
                    </div>
                    <hr />
                    <div className={`${styles["booking-status-details-container-sub"]}`}>
                        <div className={`${styles["booking-status-details-left"]}`}>
                            <p><b>Status:&nbsp;</b><span style={{ color: "orange", fontStyle: "italic" }}>Pending</span></p>
                            <p><b>Reference Number:&nbsp;</b><span>000000000</span></p>
                            <p><b>Package:&nbsp;</b><span>Overnight</span></p>
                            <p><b>Cabin:&nbsp;</b><span>Maxi Cabin</span></p>
                            <p><b>No. of Guests:&nbsp;</b><span>6</span></p>
            ...
            <section className={`${styles["booking-status-details-section"]}`}>
                <div className={`${styles["booking-status-details-container"]}`}>
                    <div className={`${styles["booking-status-details-container-heading"]}`}>
                        ...
                        <h4>Unfortunately, your booking request has been rejected due to an issue with the payment verification process.</h4>
                    </div>
                    <hr />
                    <div className={`${styles["booking-status-details-container-sub"]}`}>
                        <div className={`${styles["booking-status-details-left"]}`}>
                            <p><b>Status:&nbsp;</b><span style={{ color: "red", fontStyle: "italic" }}>Re-upload Payment Screenshot</span></p>
        ...
        return (
            <section className={`${styles["booking-status-details-section"]}`}>
                <div className={`${styles["booking-status-details-container"]}`}>
                    <div className={`${styles["booking-status-details-container-heading"]}`} style={{ paddingBottom: 5 }}>
                        <h3>Booking Not Found :&#40;</h3>
                        <h4>We're sorry, but we couldn't find a booking with the reference number you provided. Please double-check your input and try again.</h4>
                    </div>
                </div>
            </section>
        );
